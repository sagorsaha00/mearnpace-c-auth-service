...
export class Migration1736349353015 implements MigrationInterface {
   name = 'Migration1736349353015'
   ...
   public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.query(
         `CREATE TABLE "refresh_token" ("id" SERIAL NOT NULL, "expriseAt" TIMESTAMP NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "CreatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_b575dd3c21fb0831013c909e7fe" PRIMARY KEY ("id"))`,
      )
      await queryRunner.query(
